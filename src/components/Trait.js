...
const Trait = ({ layers, currentLayer, moveTrait, removeTrait, setCompPanel, setCurrentTrait, trait }) => {
	...
	return (
		<div key={trait.id} className="group m-3 px-4 py-5 bg-white shadow rounded-lg">
			...
			<div className="w-full flex flex-col items-center justify-between">
				<div className="mt-3 flex justify-between items-center">
					<p className="mr-3 text-lg font-medium text-gray-900">{trait.name}</p>
					<h3 className="text-sm text-gray-700">Rarity: % {trait.rarity}</h3>
				</div>
